...
file_prefix='/Users/tim/Box\ Sync/Warren-Lab/all_traps_final_analysis_json_files/'

file_name={}
data={}
actual_timestamp_list={}

trap_values=['A','B','D','E','F','G']
for cr_trap_value in trap_values:
    cr_file_name='master_trap_2021_10_30_'+cr_trap_value+'.json'
    f=open(file_prefix+cr_file_name)
    data=json.load()
    trapname='2021_10_30_'+cr_trap_value
    for i in data['trap_'+trapname]:
        for k in data['trap_'+trapname][i]:
